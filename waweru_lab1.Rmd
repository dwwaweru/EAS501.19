...
```{r Download Libraries, eval=FALSE}
library(ggplot2)
library(sf)
library(tidyverse)
library(dplyr)
...
```{r Final map, fig.cap = "Map 1. This map shows the distribution of the different types of images, those close to water features or close to landmarks. It is intersting to see the clustering of the different types of images which indicates where certain featurs are located within Boulder Park."}
ggplot() +
